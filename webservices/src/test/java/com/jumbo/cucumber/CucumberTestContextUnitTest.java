...
class CucumberTestContextUnitTest {
    ...
    void shouldGetQueryInformation() {
        ...
        assertThat(CucumberTestContext.getResponse().get()).isEqualTo("{}");
    }
    ...
    @Test
    void shouldGetNullForEmptyArray() {
        addQuery("{\"element\":[]}");

        assertThat(CucumberTestContext.getElement("element")).isNull();
    }
    ...
    void shouldGetArrayElement() {
        ...
        assertThat(CucumberTestContext.getElement("element")).isEqualTo("{key=value}, {key=value}");
    }
    ...
    void shouldNotReadStatusCodeForUreadableStatusCode() throws UnsupportedEncodingException {
        ...
        assertThatThrownBy(
                () ->
                    CucumberTestContext.addResponse(
                        mockedRequest("/"),
                        httpResponse,

...
@RestController
@RequestMapping("/api/webservices-kafka")
public class WebservicesKafkaResource {

    private final Logger log = LoggerFactory.getLogger(WebservicesKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WebservicesKafkaResource(KafkaProperties kafkaProperties) {
